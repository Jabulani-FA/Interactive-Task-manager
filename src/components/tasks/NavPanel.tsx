...
const NavPanel = () => {
  ...
  return (
    <div className="grid grid-cols-12">
      ...
      <div className="col-span-9 bg-neutral-950 min-h-screen px-4 py-6">
        ...
        <div className="absolute bottom-0 mb-6 flex justify-around">
          <div className="flex bg-zinc-800 p-px rounded-3xl">
            {/* Light button */}
            <button className="flex items-center gap-1 px-6 py-2 rounded-2xl hover:bg-zinc-700 transition">
              <Sun size={16} />
              <span>Light</span>
            </button>
